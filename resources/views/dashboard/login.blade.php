        ...
        <div class="container text-center">
            <div class="row" style="height: 750px">
                <div class="col align-self-center" style="background-color:#05b50b">
                    <form class="py-5" method="post" action="{{ route('dashboard.loginProcess') }}" style="color: black">
                        ...
                        <button class="btn btn-outline-light mt-3" style="width: 300px">Đăng nhập với tư cách quản trị viên</button>
                        <a href="{{ route('customers.login') }}" class="btn btn-outline-light mt-3" style="width: 300px">Đăng nhập với tư cách khách</a>
                    </form>
                </div>
            </div>
        </div>
