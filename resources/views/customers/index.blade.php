    ...
    <div style="background-color: rgba(0, 0, 0, 0.7);">
        <nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-color:#05b50b">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{route('customers.index')}}"><img src="../resources/Images/ava-web.png"
                                                                                 alt="" height=10% width=10%>
                    SugmaStadium</a>
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="row me-5" style="background-color: white">
                        - Sân vận động SugmaStadium được xem là tổ hợp sân hiện đại. Mặt sân được đầu tư với cỏ đẹp, mềm
                        mại, không trơn tượt.
                        <br>
                        - Hệ thống đèn chiếu sáng, đường chạy, lưới chắn bóng đều đẹp và đồng bộ, cũng cấp đủ ảnh sáng
                        cho các đội chơi.
                        <br>
                        - Sân bóng là nơi thường xuyên diễn ra các trận bóng vô cùng nảy lửa, những trận bóng giữa các
                        đội chơi với lối chơi thông minh, văn minh và đẹp mắt.
                        <br>
