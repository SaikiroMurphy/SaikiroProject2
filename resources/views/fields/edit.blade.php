                ...
                <div class="row">
                    <div class="col-5 mx-3">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control mt-3" id="floatingName" placeholder="Tên sân" name="name" value="{{ $fields->name }}">
                            <label for="floatingName">Tên sân</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control mt-3" id="floatingDesc" placeholder="Mô tả" name="description" value="{{ $fields->description }}">
